...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
	{ FRAMEWIN_CreateIndirect, "Theme", ID_FRAMEWIN_0, 0, 50, 300, 449, 0, 0x64, 0 },
	{ DROPDOWN_CreateIndirect, "Dropdown", ID_DROPDOWN_0, 40, 50, 200, 230, 0, 0x0, 0 },
	{ BUTTON_CreateIndirect, "OK", ID_BUTTON_0, 60, 330, 50, 40, 0, 0x0, 0 },
	{ BUTTON_CreateIndirect, "Cancel", ID_BUTTON_1, 160, 330, 50, 40, 0, 0x0, 0 },
...
void Theme_Paint()
{
	...
	GUI_SetAlpha(0x90);
	GUI_DrawBitmap(&bmapple, 320, 150);
	GUI_SetAlpha(0);
}
