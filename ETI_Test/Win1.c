...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
	...
	{ BUTTON_CreateIndirect, "Stop", ID_BUTTON_0, 500, 340, 60, 40, 0, 0x0, 0 },
	{ BUTTON_CreateIndirect, "EXIT", ID_BUTTON_1, 700, 340, 60, 40, 0, 0x0, 0 },
	{ BUTTON_CreateIndirect, "Add", ID_BUTTON_2, 600, 270, 60, 40, 0, 0x0, 0 },
	{ BUTTON_CreateIndirect, "Start", ID_BUTTON_4, 500, 270, 60, 40, 0, 0x0, 0 },
	{ BUTTON_CreateIndirect, "Del", ID_BUTTON_3, 600, 340, 60, 40, 0, 0x0, 0 },
	{ BUTTON_CreateIndirect, "Del All", ID_BUTTON_5, 700, 270, 60, 40, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
	...
	case WM_INIT_DIALOG:
		...
		SCROLLBAR_SetWidth(hScrb, 20);
			...
			LISTVIEW_AddRow(hItem, _aTable_1[List++]);
	...
	case WM_NOTIFY_PARENT:
		...
		case ID_BUTTON_2: // Notifications sent by 'Add'
			...
			break;
		case ID_BUTTON_3: // Notifications sent by 'Del'
			switch (NCode) {
			case WM_NOTIFICATION_CLICKED:
				// USER START (Optionally insert code for reacting on notification message)
				// USER END
			...
			break;
		case ID_BUTTON_5: // Notifications sent by 'Del All'
			switch (NCode) {
			case WM_NOTIFICATION_CLICKED:
				// USER START (Optionally insert code for reacting on notification message)
				// USER END
